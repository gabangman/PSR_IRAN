...
public class VungleComboUI : MonoBehaviour
{
	...
	{
		Debug.LogWarning( "onAdStartedEvent" );
	}


	void onAdEndedEvent()
	{
		Debug.LogWarning( "onAdEndedEvent" );
	}


	void onAdViewedEvent( double watched, double length )
	{
		Debug.LogWarning( "onAdViewedEvent. watched: " + watched + ", length: " + length );
	}


	void onCachedAdAvailableEvent()
	{
		Debug.LogWarning( "onCachedAdAvailableEvent" );
	}

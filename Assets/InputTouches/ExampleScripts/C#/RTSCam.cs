...
public class RTSCam : MonoBehaviour {
	...
	void Update () {
		...
		//Quaternion rotationY=Quaternion.Euler(0, Mathf.Clamp(y+orbitSpeedY, minRotY, maxRotY), 0);//*Quaternion.Euler(0, orbitSpeedY, 0);
		//Debug.Log(" t " + Mathf.Clamp(y+orbitSpeedY, minRotY, maxRotY));
		//Quaternion rotationX=Quaternion.Euler(Mathf.Clamp(x+orbitSpeedX, minRotX, maxRotX), 0, 0);

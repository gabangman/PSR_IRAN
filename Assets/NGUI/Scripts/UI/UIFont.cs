...
public class UIFont : MonoBehaviour
{
	...
	/*
	[SerializeField] public Material mMat;
	[SerializeField] public Rect mUVRect = new Rect(0f, 0f, 1f, 1f);
	[SerializeField] public BMFont mFont = new BMFont();
	[SerializeField] public int mSpacingX = 0;
	[SerializeField] public int mSpacingY = 0;
	[SerializeField] public UIAtlas mAtlas;
	[SerializeField] public UIFont mReplacement;
	[SerializeField] public float mPixelSize = 1f;
*/
	...
	//	{
	//		UILabel lbl = labels[i];
	//		if (lbl.font == this) lbl.MarkAsChanged();
	//	}
	}

...
public class UICenterOnChild : MonoBehaviour
{
	...
	//	if(isChampion) isResetPos = false;
	//	else isResetPos = true;
	//	Recenter(); 
	}
	...
	public void Recenter ()
	{
		...
		for (int i = 0, imax = trans.childCount; i < imax; ++i)
		{
			...
			int cnt = GV.ChSeason-1;
			int maxV = trans.childCount;
			if(maxV != 0){ 
				Transform t1 = trans.GetChild(cnt);

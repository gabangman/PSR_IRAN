...
public class UpgradeCarCost : MonoBehaviour {
	...
	static UpgradeCarCost instance;
	...
	public void SetDataFile(string data)
	{
		...
		TextAsset tx =(TextAsset)AccountManager.instance.txtbundle.Load("05_car_upgrade", typeof(TextAsset));
		data = tx.text;
		data = "{ \"Data\" : "+ data +"}";

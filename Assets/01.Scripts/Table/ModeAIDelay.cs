...
public class ModeAIDelay : MonoBehaviour {

	[System.Serializable]
	public class Item
	{
		public string ID; //1450
		public int ModeNum;
		public int Re_Min;
		public int Re_Max;
		public float Ctrl_Delay;
	...
	{	//dictionary.Clear();
		...
		TextAsset tx =(TextAsset)AccountManager.instance.txtbundle.Load("07_AI_control", typeof(TextAsset));
		data = tx.text;
		data = "{ \"Data\" : "+ data +"}";

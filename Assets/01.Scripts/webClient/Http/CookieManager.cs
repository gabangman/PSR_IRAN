...
namespace HTTP
{
	...
	public class CookieMananager
	{
		private static string version = "v2";
        private object cookieJarLock = new object();

		private static CookieMananager instance;
		public Dictionary< string, List< Cookie > > cookies;

        public ContentsChangedDelegate ContentsChanged;
		
		public static CookieMananager Instance
		{
			get
			{
				if ( instance == null )
				{
					instance = new CookieMananager();
				}
				return instance;
			}
		}

        public CookieMananager()
		{
            this.Clear();
		}

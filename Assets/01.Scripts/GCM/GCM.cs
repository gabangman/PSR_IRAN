...
public class GCM {
	...
	private const string CLASS_NAME = "com.Infinitecrew.PitInRacing.UnityGCMRegister";
	...
	public static void ShowToast (string message) {
		if (Application.platform == RuntimePlatform.Android) {
			using (AndroidJavaClass cls = new AndroidJavaClass ("com.Infinitecrew.PitInRacing.Util")) {;
